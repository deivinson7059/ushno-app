            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="blog-det-descrip content-fluid">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ducimus beatae veniam suscipit
                            error unde voluptatibus pariatur eaque. Odit, ullam. Dolorum, dicta! Sunt molestias
                            voluptates minima! Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore alias
                            sapiente enim excepturi cumque impedit exercitationem similique eius iste soluta adipisci
                            commodi quae, libero nulla necessitatibus harum accusantium temporibus ipsam, quidem
                            molestiae atque repellat maxime et consectetur! Molestiae sapiente maiores inventore
                            veritatis.</p>
                    </div>
                    <div class="blog-det-subtitle content-fluid">
                        <h3>How to manage your concert?</h3>
                        <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tenetur eos, sed eveniet
                            dignissimos numquam provident nihil unde ullam quod molestiae nostrum! Totam iusto
                            quibusdam, enim <a href="#">asperiores</a>neque pariatur voluptatum eos eum fuga, sequi, hic
                            odit aspernatur earum? Ratione, atque incidunt.</p>
                    </div>
                    <div class="blog-det-quote">
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Id distinctio nulla velit est quidem
                            repellendus esse non saepe cumque sapiente.</p><span>jaurge anderson</span>
                    </div>
                    <ul class="blog-det-list content-fluid">
                        <li>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus quaerat tenetur, <a
                                    href="#">aperiam</a>odit, ratione eligendi nulla quae praesentium quo, a reiciendis
                                inventore facilis veniam voluptates.</p>
                        </li>
                        <li>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ad ullam impedit, architecto
                                porro voluptas sequi ab beatae saepe quo magnam</p>
                        </li>
                        <li>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit Ad ullam impedit architecto
                                porro.</p>
                    ...
                    <div class="blog-det-author">
                        ...
                        <div class="author-content">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero ab aperiam corrupti maiores
                                animi nisi ratione maxime quae in doloremque corporis tempore earum ut voluptas
                                exercitationem.</p>
                        </div>
                    </div>
                        ...
                        <ul class="comment-list">
                            <li>
                                <div class="comment">
                                    ...
                                    <div class="comment-reply"><a href="#"><i class="fas fa-reply-all"></i>reply</a>
                                    </div>
                                </div>
                                <ul>
                                    <li>
                                        <div class="comment">
                                            ...
                                            <div class="comment-reply"><a href="#"><i
                                                        class="fas fa-reply-all"></i>reply</a></div>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                    ...
                    <div class="blog-det-form">
                        ...
                        <form>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group"><input type="text" placeholder="Your Name"><i
                                            class="fas fa-user"></i></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group"><input type="email" placeholder="Your Email"><i
                                            class="fas fa-envelope"></i></div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group"><textarea placeholder="Your Comment"></textarea><i
                                            class="fas fa-pen-nib"></i></div>
                                </div>
                                <div class="col-lg-12">
